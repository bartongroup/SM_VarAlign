...
_align_variants_parser.add_argument(
    "--max_gaussians",
    type=int,
    default=5,
...
_align_variants_parser.add_argument(
    ...
    type=int,
    default=1,
    help="Top Gaussians to select after occupancy fitting.",
)
_align_variants_parser.add_argument(
    "--species",
    type=str,
    help="Species (used for alignment filtering)",
    default="HUMAN",
)
...
def align_variants_parser(argv=None, logger=log):
    parser = argparse.ArgumentParser(
        description="Align variants to a Pfam alignment.",
...
def prointvar_analysis_parser(argv=None, logger=log):
    parser = argparse.ArgumentParser(
        description="Structural properties of alignment columns.",
