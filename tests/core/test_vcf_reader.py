...
class TestVCFReader(TestCase):
    ...
    def test_clinvar_fetch(self):
        ...
        try:
            ...
            self.fail(
                "`gnomad.Reader.fetch` raised UnicodeDecodeError whilst fetching variants from ClinVar VCF."
            )
    ...
    def test_clinvar_parsing_completes(self):
        ...
        try:
            ...
            self.fail(
                "`gnomad.Reader.vcf_row_to_table` raised ValueError for ClinVar VCF."
            )
